...
# Function takes in predictors, response, and indexes of data (nums) for subsetting the predictors and response, then finds optimal number of components for plsr for each set of data, and returns coefficients of the plsr using the optimal number of components.
